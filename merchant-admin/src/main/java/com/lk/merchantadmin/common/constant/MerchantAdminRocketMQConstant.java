...
public final class MerchantAdminRocketMQConstant {
     ...
     */
    public static final String TEMPLATE_TASK_DELAY_STATUS_CG_KEY = "coupon_merchant-admin-service_coupon-task-delay-status_cg${unique-name:}";

    /**
     * 优惠券模板推送定时执行 Topic Key
     */
    public static final String TEMPLATE_TEMPLATE_DELAY_TOPIC_KEY = "coupon_merchant-admin-service_coupon-template-delay_topic${unique-name:}";

    /**
     * 优惠券模板推送定时执行-变更记录状态消费者组 Key
     */
    public static final String TEMPLATE_TEMPLATE_DELAY_STATUS_CG_KEY = "coupon_merchant-admin-service_coupon-template-delay-status_cg${unique-name:}";
